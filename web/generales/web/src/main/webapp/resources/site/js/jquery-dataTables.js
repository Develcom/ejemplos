...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="Buscar una Actividad" class="show-full" hidden/>';
		...
		var filter = $('<div align="center" style="display:none"/>', {
	...
	function _fnFeatureHtmlPaginate ( settings )
	{
		var
			...
			node = $('<div/>').addClass("listadoGrilla").attr("align", "center").attr("style","clear: both")[0],
