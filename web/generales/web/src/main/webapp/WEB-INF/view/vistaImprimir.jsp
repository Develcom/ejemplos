...
<div ng-controller="ImprimirControlador">
	<section>
		<nav style="border-radius: 0px; margin-bottom: 1px;" class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					<div class="navbar-brand">{{$scope.modeloActual.titulo}}</div>
				</div>
				<button class="btn navbar-btn btn-default" ng-click="botonImprimir(count)">Imprimir documento <span class="glyphicon glyphicon-print"></span></button>
				<form class="navbar-form navbar-right" role="search">
					<div class="form-group">
					  <input type="text" class="form-control" placeholder="Buscar en el documento">
					</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div id="sidebar">
			    ...
			    <div id="dragbar"></div>
			<section id="genspace" class="container-fluid fixed-gen center-block">
		<div class="row" align="center">
			<!-- Se incluye el Acta en formato HTML -->
<!-- 			<embed width='800' height='350' ng-src="{{ruta}}" type='application/pdf'></embed> -->

			<iframe ng-src="https://localhost:8443/web-autenticarCiudadano/resources/reportes/Declaracion_jurada_TDM2.pdf" width='800' height='350' frameborder="0" scrolling="no">
				<p>Tu navegador no soporta iframes.</p>
			</iframe>
			<br> <br>
		</div>
				
<!-- 				<div ng-bind-html="$scope.html" carta="$scope.html"></div> -->
				<div class="alert alert-info" role="alert"><span class="glyphicon glyphicon-info-sign"></span> Fin del documento</div><br><br><br>
			</section>
			</div>
			<div id="main">
			    <aside id="genspace" class="container-fluid">
					<div class="col-sm-12">
						<div class="panel panel-success">
							<div class="panel-heading">
								<span class="glyphicon glyphicon-list-alt"></span> Datos de la solicitud
							</div>
							<table class="table table-striped table-condensed">
								<tbody>
									<tr>
										<th>Nro. de solicitud:</th>
										<td>{{$scope.modeloActual.numeroSolicitud}}</td>
									</tr>
									<tr>
										<th>Tr�mite a realizar:</th>
										<td>{{$scope.modeloActual.tramiteSolicitud}}</td>
									</tr>
									<tr class="success">
										<th>Estatus:</th>
										<td><b class="ok">{{$scope.modeloActual.codigoEstado}} <span class="glyphicon glyphicon-ok"></span></b></td>
									</tr>
									<tr>
										<th>Fecha de registro:</th>
										<td>$scope.modeloActual.fechaSolicitud</td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<button class="btn wizard-next btn-primary" type="button"
						ng-click="eventoBoton()" ng-disabled="form1.$invalid">Siguiente</button>
				</div>
		</div>
	</div>
</div>
...
<!-- 	<aside class="container-fluid ng-scope" ng-view="" ></aside> -->
  ...
  <script src="<c:url value="/site/js/directivas/directivasEntrada.js" />"></script>
...
<%--   <script src="<c:url value="http://localhost:8080/web-registrarDefuncion/site/js/controllers/rgDefuncionController.js"/>"></script> --%>
                 ...
                 <!--    -----------------RADOP---------------------    -->
   <script src="/web-nacimiento/resources/site/RADOP/js/RADOPController.js"></script>
   <script src="/web-nacimiento/resources/site/RADOP/js/validarActaController.js"></script>   
   
   
   <!--    -----------------RRFIL---------------------    -->
   <script src="/web-nacimiento/resources/site/RRFIL/js/RRFILController.js"></script>		             
  ...
  <script src="/web-permisoInhumacionCremacion/site/js/controllers/validarDatosFormController.js"></script>
    ...
    <script src="/web-permisoInhumacionCremacion/site/js/controllers/modalSolicitudCanceladaController.js"></script>
    <script src="/web-permisoInhumacionCremacion/site/js/controllers/noConformeDatosPermisoController.js"></script>
    <script src="/web-permisoInhumacionCremacion/site/js/controllers/VerificarDatosEV14Controller.js"></script>
...
<%--   <script src="<c:url value="http://localhost:8080/web-permisoInhumacionCremacion/site/js/controllers/validarDatosFormController.js" />"></script> --%>
     ...
     <script src="/web-autenticarCiudadano/js/controladores/verificacionControlador.js"></script>
    <script src="/web-autenticarCiudadano/js/controladores/imprimirControlador.js"></script>
