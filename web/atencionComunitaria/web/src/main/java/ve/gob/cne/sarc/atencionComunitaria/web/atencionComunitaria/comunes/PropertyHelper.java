package ve.gob.cne.sarc.atencionComunitaria.web.atencionComunitaria.comunes;
...
/**
 * Descripcion de la clase: Clase de apoyo que permite el acceso a propiededes declaradas en el filesystem, ademas
 * implementa la logica de preparacion de las propiedades que van a ser expuestas al cliente web.
 * 
...
public class PropertyHelper implements EscuchaAdministradorPropiedades {
    ...
    /**
     * contructor que registra al helper para escuchar actualizacion de propiedades en filesystem y realiza la primera
     * carga del cache de las propiedades expuestas al cliente web.
     * 
     * @PropertyHelper.java
     * 
     * @param props
     *            Administrador de porpiedades registrado en el IOC spring
     */
    @Autowired
    ...
    /**
     * 
     * refrescarPropiedades metodo privado que actua como cache para las propiedades que se exponen al cliente web
     * 
     * @since 6/7/2016
     * @return void
     * @author douglas.palacios
    ...
    /**
     * 
     * obtenerPropiedades devuelve las propiedades que segun el prefijo de la propiedad debe ser expuesto al cliente web
     * 
     * @since 6/7/2016
     * @return
    ...
    /**
     * 
     * consultarPropiedad dado un nombre de propiedad expuesta al cliente web como parametro de busqueda devuelve su
     * valor obtenido del cache del helper
     * 
     * @since 6/7/2016
     * @param propiedad
     * @return
    ...
    /**
     * 
     * validarAcceso dado un string representando una propiedad expuesta al cliente web determina si el prefijo es igual
     * a la propiedad IDS_PARCIALES_VALIDOS_WEB
     * 
     * @since 6/7/2016
     * @param propiedad
     * @return
