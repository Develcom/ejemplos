package ve.gob.cne.sarc.autenticarCiudadano.excepciones;
...
public class AutenticarCiudadanoExcepciones  extends Exception{
	...
	public AutenticarCiudadanoExcepciones(String errCode){
		this.errCode =  errCode;
		this.errMsg = "";
	}
