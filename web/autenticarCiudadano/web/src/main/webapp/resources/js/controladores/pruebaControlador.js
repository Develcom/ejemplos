App.controller('PruebaControlador',function($scope,$http,$rootScope,$uibModal,registrarRutasService){
	var vm = this;
	...
	vm.rutas = {
	              ...
	              confirmar : {ruta : registrarRutasService.propiedades['sarc.web.autenticarCiudadano.enviarAverificacion.url'], funcion : vm.manejarActualizacion, metodo : "POST"}
			   };
