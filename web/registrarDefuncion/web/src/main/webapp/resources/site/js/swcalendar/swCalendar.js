...
.directive('swCalendarExtended', function($parse) {
	return {
		...
		require: 'ngModel',
		template:
			'<div class=" form-group" ng-class="{\'col-sm-8\': colwrap!=undefined,\'col-sm-12\': vertical!=undefined,\'col-sm-8\': horizontal!=undefined,\'has-default\': dia2== undefined || mes2== undefined || ano2== undefined || hora2==undefined || minuto2== undefined, \'has-success\': dia2!= undefined && mes2!= undefined && ano2!= undefined && hora2!= undefined && minuto2!=undefined}" >'
			+'<input type="hidden" value="{{orientation}}"> ' 
			+'<label class=" control-label"ng-class="{\'col-sm-3\': vertical==undefined}" >{{label}}{{ngModel}}</label>'     
			+'<div class="input-group" >'
