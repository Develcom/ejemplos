...
App.controller('controladorRDEFUPCA',function($scope,$http,$rootScope,$uibModal){
...
//	vm.cargarDocModal = false;
	...
	vm.solicitudCerrada = function(){
		presentarModal($scope,$uibModal,vm.finModal1,'El NUI fue actualizado exitosamente',$rootScope.tituloWizard,'a');

	}
	vm.finModal1 = function(){
		vm.modalECU();
	}
	
	vm.modalECU = function(){
		presentarModal($scope,$uibModal,vm.finModal2,'El ECU del fallecido fue actualizado exitosamente',$rootScope.tituloWizard,'a');
	}
	
	vm.finModal2 = function(){
		vm.modalLibroCivil();
	}
	
	vm.modalLibroCivil = function(){
		presentarModal($scope,$uibModal,vm.finModal3,'El libro de registro civil fue actualizado exitosamente',$rootScope.tituloWizard,'a');
	}
	
	vm.finModal3 = function(){
		vm.modalLibroDiario();
	}
	
	vm.modalLibroDiario = function(){
