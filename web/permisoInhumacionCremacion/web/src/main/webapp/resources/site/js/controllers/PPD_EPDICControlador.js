...
App.controller('controladorEPDIC_PPD', function ($scope, $http, $uibModal, $rootScope, validaciones) {
    ...
    vm.okCarga = function () {
        vm.cargarDocModal = false;
        llamadaAjax($http, $scope, vm, '/web-permisoInhumacionCremacion/cargaExitosa', vm.modelo, vm.presentarVista2, "POST");

    }

    vm.respuestaActualizar = function () {
        llamadaAjax($http, $scope, vm, '/web-permisoInhumacionCremacion/actualizarEstado', vm.modelo, vm.modalCerrar, "POST");

    }

    vm.modalCerrar = function () {
        presentarModal($scope, $uibModal, vm.solicitudCerrada, 'Solicitud cerrada correctamente, permiso de inhumación y/o cremación generado', $rootScope.tituloWizard, 'a');
