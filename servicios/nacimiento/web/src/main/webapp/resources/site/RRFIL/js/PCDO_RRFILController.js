App.controller('controlador_PCDO_RRFIL', function($scope,$http,$uibModal,$rootScope) {
	 console.log("------ESTATUUUU PCDO-----" + $rootScope.objectSelected.codigoEstadoSolicitud);
	    ...
	    vm.modalCerrar = function () {
	        presentarModal2($scope, $uibModal, vm.modalCerrar1,vm.modalCerrar1, '¿Desea enviar un folio el tribunal?', $rootScope.tituloWizard, 's');

	    }
	    vm.modalCerrar1 = function () {
	        presentarModal($scope, $uibModal, vm.solicitudCerrada, 'Se generó la tarea al módulo de notas marginales', $rootScope.tituloWizard, 'a');
