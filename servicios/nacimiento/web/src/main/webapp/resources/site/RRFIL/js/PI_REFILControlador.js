App.controller('PI_RRFILcontroller', function($scope,$http,$uibModal,$rootScope, $sce) {
console.log("----------------controlador pi recomposicion");
    ...
    vm.estados = {
        ...
        iniciarTramite:{ruta:'/web-nacimiento/presentarImprimirRRFIL', funcion:vm.presentarPdf, metodo:"POST"},
        finalizarTramite:{ruta:'/web-nacimiento/presentarSatisfactorioRRFIL', funcion:vm.presentarPdf, metodo:"POST"}//,
