App.controller('PVR_RRFILControlador', function($scope,$http,$uibModal,$rootScope) {


	console.log("--------> PVR_RRFILControlador----"+$rootScope.objectSelected.codigoEstadoSolicitud);
	    var vm = this;
...
//		 }
		...
		vm.estados = {
				...
				validaReporte : {ruta : '/web-nacimiento/verificacionDeclarante',funcion : vm.presentarVista2, metodo : "POST"}
			};
	    ...
	    vm.siguiente = function(){
	        ...
	        if(vm.confirmarDatosForm){
	            console.log("vm.modelo.permiso"+vm.modelo.permiso1);
