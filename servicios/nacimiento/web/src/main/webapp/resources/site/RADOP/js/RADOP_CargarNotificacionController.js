App.controller('RADOP_CargarNotificacionController',function($scope,$http,$rootScope,$uibModal){
 	 ...
 	 */
 	 ...
 	 vm.okCarga = function(){
 		 vm.cargarDocModal = false;
 		 llamadaAjax($http, $scope, vm, '/web-nacimiento/RADOP_NT_CargarDocSatisf', vm.modelo, vm.presentarVista2, "POST");		
 	 }
 	 ...
 	 vm.siguiente = function(){
 	  ...
 	  if(vm.actualizar){
 		 ...
 		 vm.cambioStatus();
 		  ...
 		  console.log("cargaaaaAAAAAAAAAAAAAAAAAAAAAAA");
 		  vm.cargarDoc();
 		  //vm.cargarDocModal = false;
 		  return;
 	  }
