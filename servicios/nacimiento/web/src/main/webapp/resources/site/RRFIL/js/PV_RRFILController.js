...
App.controller('PV_RRFILControlador', function($scope,$http,$uibModal,$rootScope) {
console.log("--------> PV_RRFILControlador");
    var vm = this;
...
//	 }
    ...
    vm.estados = {
        ...
        validaReporte: {ruta : '/web-nacimiento/validarReporteConforme', funcion : vm.presentarVista2, metodo: "POST"}
    };
