App.controller('RADOP_PvController',function($scope,$http,$rootScope,$uibModal){
...
//	 }
	 ...
	 vm.rutas = [
	       ...
	       {ruta : '/web-nacimiento/RADOP_verificacionRC', funcion : vm.presentarVista, metodo: 'POST'},
	   ];
