package ve.gob.cne.sarc.participante.core.participante.aop;
...
import ve.gob.cne.sarc.participante.core.participante.exception.ResourceNotFoundException;
...
public class NoResultExceptionAspect {
     ...
     */
    @AfterThrowing(pointcut = "execution(* ve.gob.cne.sarc.participante.core.participante.controllers.*.**(..))", 
            throwing = "e")
