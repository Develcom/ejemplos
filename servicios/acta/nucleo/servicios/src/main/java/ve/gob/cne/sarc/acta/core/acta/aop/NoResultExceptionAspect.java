package ve.gob.cne.sarc.acta.core.acta.aop;
...
public class NoResultExceptionAspect {
    ...
    /**
     * Envia la excepcion capturada
     * @param joinPoint Objeto de tipo JoinPoint
     * @param e Objeto de tipo NoResultException
     */
    @AfterThrowing(pointcut = "execution(* ve.gob.cne.sarc.acta.core.acta.controllers.*.**(..))", throwing = "e")
