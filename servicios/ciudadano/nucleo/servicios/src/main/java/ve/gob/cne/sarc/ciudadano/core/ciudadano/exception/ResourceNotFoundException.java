package ve.gob.cne.sarc.ciudadano.core.ciudadano.exception;
...
public class ResourceNotFoundException extends RuntimeException implements Serializable {
    ...
    /**
     * Metodo para mostrar la causa de error por recurso no encontrado a partir del mensaje de error.
     *
     * @param message
     * @param cause
     */
