...
/**
 * SolicitanteTipDocEnteMapper.java
...
public interface SolicitanteTipDocEnteMapper {
    ...
    TipoDocumento entitiesToBOs(SolicitanteTipDocEnteEntidad solicitanteTipDocEnteEntidad);
