...
/**
 * SolicitanteTipDocDecMapper.java
...
public interface SolicitanteTipDocDecMapper {
    ...
    TipoDocumento entitiesToBOs(SolicitanteTipDocDecEntidad solicitanteTipDocDecEntidad);
