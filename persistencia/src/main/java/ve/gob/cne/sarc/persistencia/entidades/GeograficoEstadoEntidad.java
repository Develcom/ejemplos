...
@ClassEspecification(name = "Estado", identifier = "Nombre", canBeListed = true,
        generatesTask=SincronizationPolicy.BROADCAST)
public class GeograficoEstadoEntidad implements Serializable {
    ...
    private List<GeograficoInhospitoEntidad> inhospitos;

    @FieldDeletionStrategy(options = DeletionStrategy.CASCADE_OPTIONS)
    private List<GeograficoMunicipioEntidad> municipios;
    ...
    public GeograficoEstadoEntidad() {
        // Constructor vacío
    }
    ...
    public TipoGeograficoEntidad getTipoGeografico() {
        ...
        tipoGeograficoEntidad.setId(2);
        tipoGeograficoEntidad.setTxDescripcion("Estado");
    ...
    @OneToMany(mappedBy = "geograficoEstadoEntidad")
    @MethodEspecification(targetedAttribute="inhospitos")
    public List<GeograficoInhospitoEntidad> getInhospitos() {
        return inhospitos;
    }

    public void setInhospitos(List<GeograficoInhospitoEntidad> inhospitos) {
        this.inhospitos = inhospitos;
    }

    @OneToMany(mappedBy = "geograficoEstadoEntidad")
    @MethodEspecification(targetedAttribute="municipios")
    public List<GeograficoMunicipioEntidad> getMunicipios() {
        return municipios;
    }

    public void setMunicipios(List<GeograficoMunicipioEntidad> municipios) {
    ...
    public boolean equals(Object o) {
        ...
        GeograficoEstadoEntidad that = (GeograficoEstadoEntidad) o;
