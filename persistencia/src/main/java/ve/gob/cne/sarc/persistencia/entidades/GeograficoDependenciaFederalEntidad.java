...
@ClassEspecification(name = "Dependencia Federal", identifier = "Nombre", canBeListed = true,
        generatesTask=SincronizationPolicy.BROADCAST)
public class GeograficoDependenciaFederalEntidad implements Serializable {
    ...
    public GeograficoDependenciaFederalEntidad() {
        // Constructor vacío
    }
    ...
    public TipoGeograficoEntidad getTipoGeografico() {
        ...
        tipoGeograficoEntidad.setId(5);
        tipoGeograficoEntidad.setTxDescripcion("Dependencia Federal");
    ...
    public boolean equals(Object o) {
        ...
        GeograficoDependenciaFederalEntidad that = (GeograficoDependenciaFederalEntidad) o;
    ...
    public String toString() {
        return "GeograficoDependenciaFederalEntidad{" +
                "id=" + id +
                ", nombre='" + nombre + '\'' +
                '}';
    }
