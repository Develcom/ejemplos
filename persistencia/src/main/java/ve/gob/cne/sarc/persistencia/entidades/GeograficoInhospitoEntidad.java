...
@ClassEspecification(name = "Inhóspito", identifier = "Nombre", canBeListed = true,
        generatesTask=SincronizationPolicy.BROADCAST)
public class GeograficoInhospitoEntidad implements Serializable {
    ...
    public TipoGeograficoEntidad getTipoGeografico() {
        ...
        tipoGeograficoEntidad.setId(6);
        tipoGeograficoEntidad.setTxDescripcion("Inhóspito");
    ...
    public boolean equals(Object o) {
        ...
        GeograficoInhospitoEntidad that = (GeograficoInhospitoEntidad) o;
    ...
    public String toString() {
        return "GeograficoInhospitoEntidad{" +
                "id=" + id +
                ", nombre='" + nombre + '\'' +
                '}';
    }
