...
@ClassEspecification(name = "Municipio", identifier = "Nombre", canBeListed = true,
        generatesTask=SincronizationPolicy.BROADCAST)
public class GeograficoMunicipioEntidad implements Serializable {
    ...
    private List<GeograficoParroquiaEntidad> parroquias;
    ...
    public TipoGeograficoEntidad getTipoGeografico() {
        ...
        tipoGeograficoEntidad.setId(3);
        tipoGeograficoEntidad.setTxDescripcion("Municipio");
    ...
    @MethodEspecification(targetedAttribute="geograficoEstadoEntidad")
    public GeograficoEstadoEntidad getGeograficoEstadoEntidad() {
        return geograficoEstadoEntidad;
    }

    public void setGeograficoEstadoEntidad(GeograficoEstadoEntidad geograficoEstadoEntidad) {
        this.geograficoEstadoEntidad = geograficoEstadoEntidad;
    }

    @OneToMany(mappedBy = "geograficoMunicipioEntidad")
    @MethodEspecification(targetedAttribute="parroquias")
    public List<GeograficoParroquiaEntidad> getParroquias() {
        return parroquias;
    }

    public void setParroquias(List<GeograficoParroquiaEntidad> parroquias) {
    ...
    public boolean equals(Object o) {
        ...
        GeograficoMunicipioEntidad that = (GeograficoMunicipioEntidad) o;
